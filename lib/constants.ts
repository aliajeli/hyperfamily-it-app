...
// POS terminals and scales are never connected to remotely, so they are
// excluded from Connection methods and Credential assignments.
export const CONNECTABLE_DEVICE_TYPES = DEVICE_TYPES.filter((type) => type !== 'POS' && type !== 'Scale')
