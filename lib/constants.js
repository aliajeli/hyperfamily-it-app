...
export const DEFAULT_SETTINGS = {
  ...
  // Update Store App: where Store Commerce lives on each checkout and where
  // pushed files are deployed (local drive paths on the checkout machines).
  store_commerce_path: 'C:\\Store Commerce\\StoreCommerce.exe',
