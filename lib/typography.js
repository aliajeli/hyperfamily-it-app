...
export const MONO_FONTS = [
  {
    ...
    stack: 'ui-monospace, SFMono-Regular, "Cascadia Mono", Consolas, "Liberation Mono", monospace'
  },
...
export const FONT_GROUPS = [
  {
    ...
    sizeVariable: '--font-header-scale',
    description: 'Page titles and the top bar',
  ...
  },
  {
    ...
    label: 'Title',
    variable: '--font-title',
    sizeVariable: '--font-title-scale',
    description: 'Card and section headings',
    sample: 'FortiClient SSL VPN'
  },
  {
    id: 'text',
    label: 'Text',
    variable: '--font-text',
    sizeVariable: '--font-text-scale',
    description: 'Body copy, labels and buttons',
  ...
  },
  {
    ...
    label: 'Info',
    variable: '--font-info',
    sizeVariable: '--font-info-scale',
    description: 'Hints, captions and helper text',
    sample: 'Credentials are encrypted with Windows DPAPI.'
  },
  {
    id: 'mono',
    label: 'Monospace',
    variable: '--font-mono',
    sizeVariable: '--font-mono-scale',
    description: 'IP addresses, ports and console text',
    sample: '10.40.5.14:8291 — Gi1/0/24'
  }
]
...
export function rememberTypography(settings) {
  try {
    localStorage.setItem(TYPOGRAPHY_STORAGE_KEY, JSON.stringify(typographySnapshot(settings)))
  } catch {
