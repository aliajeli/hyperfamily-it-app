...
/**
 * Applies a theme with one clean, fast fade (v2.0.17).
 *
 ...
 * the new theme in a single quick ~0.3s fade — headers, cards, text and
 * borders all change together, exactly like a fade transition in a video.
 *
