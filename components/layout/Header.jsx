...
export default function Header({ user }) {
  return <header className="app-header drag-region fixed right-0 top-0 flex h-14 items-center justify-end border-b bg-[rgb(var(--canvas)/.76)] px-3.5 backdrop-blur-xl md:px-5">
