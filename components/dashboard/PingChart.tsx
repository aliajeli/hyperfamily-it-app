...
function StatusDot({ cx, cy, payload }: any) {
...
export default function PingChart({ history = [], compact = false, detailed = false }: any) {
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <ReferenceArea
            {...({ y1: 0, y2: 300, fill: '#A3BE8C', fillOpacity: detailed ? 0.1 : 0.07 } as any)}
          />
          {showAxes ? (
            <>
              <XAxis
