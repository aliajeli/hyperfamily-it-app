...
t(
  'device tools no longer hosts the matrix',
...
await open('Client')
t(
  'Client offers TeamViewer as well',
...
t(
  'promoting TeamViewer moves the star',
