      ...
      <div className="flex h-[calc(100vh-7rem)] min-h-[560px] flex-col gap-3" onKeyDown={onKeyDown}>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                  ...
                  <div className="flex items-center gap-1.5" role="group" aria-label="Note colour">
                    ...
                    {NOTE_COLORS.map((entry) => {
                      ...
                      return (
                        ...
                        >
                          {active && (
                            <Check size={11} className="text-[rgb(var(--canvas))]" strokeWidth={3.5} />
                          )}
                        </button>
                      )
                    })}
                    ...
                    {PRIORITIES.map((level) => {
                      ...
                      return (
                        <button
                          ...
                          style={
                            active ? { color: level.tone, background: 'rgb(var(--surface))' } : undefined
                          }
                        >
                ...
                <div className="flex items-center gap-2 px-1 text-xs text-[rgb(var(--muted))]">
                  ...
                  {draft.updated_at && (
                    <span className="hidden sm:inline">Updated {when(draft.updated_at)}</span>
                  )}
                  <span
                    className={cn(
        ...
        {menu &&
          (() => {
            ...
            const top = Math.min(
              menu.y,
              (typeof window !== 'undefined' ? window.innerHeight : 800) - height - 12
            )
            return (
              <>
                <div
                    ...
                    {NOTE_COLORS.map((entry) => {
                      ...
                      return (
                        <button
                          ...
                          onClick={() => {
                            setMenu(null)
                            quickUpdate(target, { color: entry.id }, 'Note colour updated')
                          }}
                          className={cn(
                        ...
                        >
                          {active && (
                            <Check size={10} className="text-[rgb(var(--canvas))]" strokeWidth={3.5} />
                          )}
                        </button>
                      )
                    })}
                    ...
                    {PRIORITIES.map((level) => {
                      ...
                      return (
                        <button
                          ...
                          onClick={() => {
                            setMenu(null)
                            quickUpdate(target, { priority: level.id }, 'Priority updated')
                          }}
                          className={cn(
